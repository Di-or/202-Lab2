...
forktest(void)
{
  ...
  3e:	42650513          	addi	a0,a0,1062 # 460 <sched_tickets+0xa>
  ...
  68:	40c50513          	addi	a0,a0,1036 # 470 <sched_tickets+0x1a>
  ...
  b8:	40c50513          	addi	a0,a0,1036 # 4c0 <sched_tickets+0x6a>
  ...
  d4:	3c050513          	addi	a0,a0,960 # 490 <sched_tickets+0x3a>
  ...
  ee:	3be50513          	addi	a0,a0,958 # 4a8 <sched_tickets+0x52>
...
000000000000044e <sched_statistics>:
...
0000000000000456 <sched_tickets>:
