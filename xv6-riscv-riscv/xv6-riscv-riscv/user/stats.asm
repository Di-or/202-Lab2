...
0000000000000352 <sched_statistics>:
...
000000000000035a <sched_tickets>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3aa:	45250513          	addi	a0,a0,1106 # 7f8 <digits>
 3ae:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 476:	386b8b93          	addi	s7,s7,902 # 7f8 <digits>
 ...
 5b6:	23e90913          	addi	s2,s2,574 # 7f0 <malloc+0xf8>
        while(*s != 0){
